...
class Client extends OAuth2Client {
  ...
  */
  ...
  async setChargingMode(serialNumber, position, mode) {
    ...
    return this.put({ path, query: '', json, body: '', headers: {} });
  }
  ...
  */
  ...
  async _get(path) {
    ...
    return this.get({ path, query: '', headers: {} });
  }
  ...
  async _patch(path, json = null) {
    ...
    return this.patch({ path, query: '', json, body: null, headers: {} });
  }
  ...
  async _post(path, json = null) {
    ...
    return this.post({ path, query: '', json, body: null, headers: {} });
  }
  ...
  */
  ...
  async onHandleNotOK({ body, status, statusText, headers }) {
    this.error('Request not OK', JSON.stringify({ body, status, statusText, headers }));
