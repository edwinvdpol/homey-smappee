...
class MqttDevice extends Device {
  ...
  */
  ...
  async connect() {
    ...
    this.topic = `servicelocation/${this.serviceLocationId}/${this.subscribeTopic()}`;
    ...
    const client = mqtt.connect('mqtts://mqtt.smappee.net:443', {
      ...
      clean: true,
      connectTimeout: 5000,
      username: this.serviceLocationId,
      password: this.serviceLocationId,
  ...
  */
  ...
  async track(on = true) {
    ...
    const topic = `servicelocation/${this.serviceLocationId}/tracking`;
